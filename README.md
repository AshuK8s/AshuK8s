...
## Technologies 🧑🏻‍💻
[![My Skills](https://skillicons.dev/icons?i=kubernetes,docker,python,java,c,cpp,fastapi,flask,aws,gcp,azure,flutter)](https://skillicons.dev)
[![My Skills](https://skillicons.dev/icons?i=git,githubactions,linux)](https://skillicons.dev) 
